...
const sidebarLinks = [
  ...
  { icon: Briefcase, key: "jobs", href: "/dashboard" },
  { icon: Users, key: "candidates", href: "/dashboard" },
  { icon: Video, key: "interviews", href: "/dashboard" },
  { icon: MessageSquare, key: "messages", href: "/dashboard" },
  { icon: BarChart3, key: "analytics", href: "/dashboard" },
  { icon: UserCircle, key: "profile", href: "/dashboard" },
    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <div className="absolute bottom-4 start-0 end-0 px-3">
          <Link
            href="/login"
            className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-error transition-colors hover:bg-error/10"
          >
      ...
      <div className="flex flex-1 flex-col">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-background/80 px-4 backdrop-blur-md sm:px-6">
          ...
          <div className="text-lg font-semibold text-foreground">{t("welcome")}</div>
